...
public class SaveConfig {
	...
	public static void load() {
		...
		config.addDefault("playeroptions.gamemode", "");
		config.addDefault("playeroptions.health", false);
		config.addDefault("playeroptions.hunger", true);
		config.options().copyDefaults(true);
		save();
	}
	public static void reload() {
		if (configFile == null) {
			configFile = new File("plugins/TitaniumHub/SaveConfig.yml");
		}
